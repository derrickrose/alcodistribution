...
public class DataBaseDAO extends DAOFactory {
	...
	private DataBaseDAO(String driver, String url, String login,
			String password) {
		loadDriver(driver);
		this.driver = driver;
		this.url = url;
...
//	}
	...
	private DAOFactory buildDAOInstance() {
		...
		InputStream mysqlPropertiesFile = classLoader
				.getResourceAsStream(MYSQL_PROPERTIES_PATH);
		try {
	...
	public Connection getConnection() throws SQLException {
		return DriverManager.getConnection(url, login, "");
	}
