...
public class FormHandler {
	...
	private static Form pushTechConsultingForm = null;//this long name in order to avoid wrong access memory 
	...
	public static void validateForm(String linkToCrawl, String dataBaseLink,
		...
		pushTechConsultingForm = new Form(linkToCrawl, dataBaseLink, dataBaseUser, userPassWord);
	}
